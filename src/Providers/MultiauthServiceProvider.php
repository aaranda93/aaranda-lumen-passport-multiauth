...
namespace Aaranda\LumenPassportMultiauth\Providers;

use Illuminate\Auth\AuthServiceProvider;
use Illuminate\Support\Facades\Event;
use Laravel\Passport\Events\AccessTokenCreated;
use Aaranda\LumenPassportMultiauth\Auth\AuthManager;
use Aaranda\LumenPassportMultiauth\Http\Middleware\AddCustomProvider;
