...
namespace Aaranda\LumenPassportMultiauth\Http\Middleware;
...
use Aaranda\LumenPassportMultiauth\Config\AuthConfigHelper;
use Aaranda\LumenPassportMultiauth\Facades\ServerRequest;
use Aaranda\LumenPassportMultiauth\Guards\GuardChecker;
use Aaranda\LumenPassportMultiauth\PassportMultiauth;
use Aaranda\LumenPassportMultiauth\Provider as Token;
use Aaranda\LumenPassportMultiauth\ProviderRepository;
...
class MultiAuthenticate extends Authenticate
{
     ...
     * @throws \Aaranda\LumenPassportMultiauth\Exceptions\MissingConfigException
     */
